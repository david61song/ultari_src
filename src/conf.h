...
#ifndef SYSCONFDIR
#define DEFAULT_CONFIGFILE "/etc/config/ultari"
#else
#define DEFAULT_CONFIGFILE SYSCONFDIR"/ultari/ultari.conf"
#endif
#define DEFAULT_DAEMON 1
#define DEFAULT_DEBUGLEVEL 1
#define DEFAULT_MAXCLIENTS 20
#define DEFAULT_GATEWAY_IPRANGE "0.0.0.0/0"
#define DEFAULT_GATEWAYNAME "Ultari"
...
#define DEFAULT_WEBROOT "/etc/ultari/htdocs"
#define DEFAULT_SPLASHPAGE "splash.html"
#define DEFAULT_STATUSPAGE "status.html"
#define DEFAULT_AUTHDIR "ultari_auth"
#define DEFAULT_DENYDIR "ultari_deny"
...
#define DEFAULT_INTERNAL_SOCK "/tmp/ultarictl.sock"
...
typedef struct {
	...
	char *ultarictl_sock;		/**< @brief ultarictl path to socket */
	...
	char *gw_domain;		/**< @brief A domain under which ultari is reachable. */
